"""Standalone test for inference interface (no dependencies)."""
...
# Import only standalone module (no package dependencies)
from hesitation.inference.standalone import HesitationPredictor, Prediction
