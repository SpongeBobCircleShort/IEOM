...
% generateHumanEventSchedule: Create deterministic human-event schedule for one scenario/seed.
    ...
    schedule = struct( ...
        ...
        'environment_name', scenario.environment_name, ...
        'seed', seed, ...
        ...
        'task_precision_required', scenario.task_precision_required, ...
        'workspace_constraint_level', scenario.workspace_constraint_level, ...
        'expected_task_duration_sec', scenario.expected_task_duration_sec, ...
        'expected_pause_duration_sec', scenario.expected_pause_duration_sec, ...
        'occlusion_level', scenario.occlusion_level, ...
        'ghost_proximity_level', scenario.ghost_proximity_level ...
    );
end
