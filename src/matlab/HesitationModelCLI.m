classdef HesitationModelCLI
    ...
    methods
        ...
        function prediction = predict_single(obj, features)
            ...
            % Build CLI command
            cmd = sprintf(...
                'PYTHONPATH=%s %s -m hesitation.inference.cli predict --mean-hand-speed %.6f --pause-ratio %.6f --progress-delta %.6f --reversal-count %d --retry-count %d --task-step-id %d --human-robot-distance %.6f', ...
